...
[Setup and Configuration](../README.md#set-up-and-configuration) is the same as for the Watcher
...
Specifies import parameters for:
    ...
    - <details><summary>Data Objects (example)</summary>
    ...
    - <details><summary>Workflow Metadata</summary>
...
- <details><summary>site_configuration.toml</summary>
...
- Run the import process *without* updating the database (`--update-db` flag is not used):
    ...
    ```bash
    (nmdc-automation-py3.11) (base) nmdcda@perlmutter:login06:~/nmdc_automation/dev> python nmdc_automation/nmdc_automation/run_process/run_import.py import-projects import_projects/import.tsv nmdc_automation/configs/import.yaml site_configuration_nersc.toml
    ```
